package com.ead.notification.adapter.inbound.exceptionhandler;

import com.ead.notification.adapter.response.FieldErrorDetailsResponse;
import com.ead.notification.adapter.response.ProblemResponse;
import com.ead.notification.core.exception.DomainNotFoundException;
import com.ead.notification.core.exception.NotificationException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleBusinessException(final NotificationException ex, final WebRequest request){
